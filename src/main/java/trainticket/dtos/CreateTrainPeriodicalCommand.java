...
@Getter
@Setter
public class CreateTrainPeriodicalCommand {
    ...
    @PositiveOrZero(message = "Periodical hour cannot be negative")
    @NotNull
    @Schema(description="Periodical starting train: periods in hour", example = "1")
    private int plusHours;

    @PositiveOrZero(message = "Periodical minutes cannot be negative")
    @NotNull
    @Schema(description="Periodical starting train: periods in minutes", example = "1")
    private int plusMinutes;

    @Positive(message = "Number of the periods cannot be negative")
    @NotNull
    @Schema(description="Periodical starting train: number of periods", example = "1")
